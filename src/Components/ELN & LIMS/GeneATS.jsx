    ...
    <div className="right-sub-contents">
      ...
      <div className="card-subdatas">
        ...
        >
          ...
          facilitating seamless ticket generation and management.
          <br />
          <br />
          It ensures that sample analysis requests are efficiently tracked and
          processed, enhancing communication and coordination among team
          members.
          <br />
          <br />
          The system integrates robust features that reduce turnaround time and
          improve overall efficiency.
          <br />
          <br />
          By streamlining the entire process, Gene ATS supports better resource
