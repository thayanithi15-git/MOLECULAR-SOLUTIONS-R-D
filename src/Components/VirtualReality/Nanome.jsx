  ...
  return (
    <div className="right-sub-contents">
      <div className="title-productspage">
        <img
          src="https://molecularsolutions.co.in/products/assets/nanome-img-CuV8MKbV.png"
      ...
      <div className="card-subdatas">
        <div
          ...
          ref={textRef}>
          Nanome is a mixed virtual reality software that revolutionizes the way
          scientists, researchers, and educators interact with molecular
          structures on an atomic level.
          <br />
          <br />
          It offers a 3D immersive environment where users can visualize and
          interact with molecular formations intuitively.
          <br />
          <br />
          Designed for collaboration, Nanome integrates seamlessly with other
          software and databases, allowing global teams to work together in real
          time.
          <br />
          <br />
          This platform accelerates discovery and development by making
          molecular design more accessible and interactive.
        </div>
        <div>
          {isOverflowing && (
            <div
