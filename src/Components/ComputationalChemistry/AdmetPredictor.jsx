    ...
    <div className="right-sub-contents">
      ...
      <div className="card-subdatas">
        ...
        >
          ...
          based on your own data. <br />
          <br />
          The newest module offers advanced data mining, clustering, and matched
          molecular pair analysis. The program has an intuitive user interface
          that allows one to easily manipulate and visualize data.
        </div>
        <div>
          {isOverflowing && (
            <div
